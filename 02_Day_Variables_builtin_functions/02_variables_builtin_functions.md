...
```py
first_name, last_name, country, age, is_married = 'Harsha', 'Yetayeh', 'Helsink', 250, True
...
print(type({'name':'Harsha','age':250, 'is_married':250}))    # dict
